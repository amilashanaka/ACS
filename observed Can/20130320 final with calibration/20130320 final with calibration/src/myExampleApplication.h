...
#ifndef __myExampleApplication_H__
#define __myExampleApplication_H__

#include "Ogre.h"
#include "OgreConfigFile.h"
#include "myFramelistner.h"
...
#else
        mFrameListener= new myFramelistner(mWindow, mCamera);
#endif
