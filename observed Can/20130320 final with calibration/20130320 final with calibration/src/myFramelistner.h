...
class myFramelistner: public FrameListener, public WindowEventListener
{
...
public:
	...
	myFramelistner(RenderWindow* win, Camera* cam, bool bufferedKeys = false, bool bufferedMouse = false,
